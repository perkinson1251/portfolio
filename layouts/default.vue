...
.background::before {
  @apply absolute -z-[1] h-full w-full bg-transparent bg-[length:90px_95px] bg-scroll bg-clip-border bg-left-top bg-repeat bg-origin-padding transition-all duration-500 content-[''] mask-fade;
